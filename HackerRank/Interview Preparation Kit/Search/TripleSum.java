...
public class Solution {
    ...
    static long triplets(int[] a, int[] b, int[] c) {
        // construct arrays of sorted distinct elements
        ...
        int x, y, z;
        x = y = z = 0; // indecies of arr, brr and crr
        long count = 0; // count possible combinations
        while(y < brr.length) {
            ...
            count += (long)x * z; // avoiding overflow
            y++;
        }
        return count;
