...
void checkMagazine(vector<string> magazine, vector<string> note) {
  map<string, int> magmap; // map to store words in magazine with its
                             // frequency
  map<string, int> notmap; // map to store words in notes with its frequency
  ...
  for (it = notmap.begin(); it != notmap.end(); it++) {
